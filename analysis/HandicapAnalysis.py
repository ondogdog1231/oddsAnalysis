...
class oddsHandicap():
    ...
    def dataCrawler(self):
        ...
        for item in result:
            ...
            url = "http://odds.500.com/fenxi/yazhi-%s.shtml?cids=3" % item["fid"]
            print url
            detailResult = self.requestsFunc(url)
            # print detailResult.decode("gbk")
            print self.webGraber(detailResult)
...
odd = oddsHandicap("http://liansai.500.com/index.php?c=score&a=getmatch&stid=11944&round=2")
odd.dataCrawler()
